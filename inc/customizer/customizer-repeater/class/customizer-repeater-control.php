...
class Shop_Isle_Repeater_Controler extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'customizer-repeater-iconpicker-style', get_template_directory_uri() . '/inc/customizer/customizer-repeater/icon-picker/style.css' );

		wp_enqueue_script( 'customizer-repeater-iconpicker', get_template_directory_uri() . '/inc/customizer/customizer-repeater/icon-picker/script.js', array( 'jquery' ), '1.0.0', true );
